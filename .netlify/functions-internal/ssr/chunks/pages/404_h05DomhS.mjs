import { l as lookup, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_-s52BX9S.mjs';
import { A as AstroError, b as InvalidImageService, c as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, d as createAstro, e as createComponent, f as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, g as addAttribute, s as spreadAttributes, h as defineScriptVars, i as renderComponent, u as unescapeHTML, j as Fragment, k as renderHead, l as renderSlot } from '../astro_CDPvs3qL.mjs';
import 'kleur/colors';
/* empty css                           */
import fs from 'fs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_-s52BX9S.mjs'
    ).then(n => n.s).catch((e) => {
...
const imageConfig = {"service":{"entrypoint":"astro/assets/services/squoosh","config":{}},"domains":[],"remotePatterns":[]};
					const outDir = new URL("file:///home/themanyface/Projects/personal_website/mywebsite/furkaneyazici/dist/");
