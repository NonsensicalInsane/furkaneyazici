import { A as AstroError, n as UnknownContentCollectionError, e as createComponent, o as renderUniqueStylesheet, p as renderScriptElement, q as createHeadAndContent, r as renderTemplate, i as renderComponent, u as unescapeHTML, d as createAstro, m as maybeRenderHead, j as Fragment, g as addAttribute } from '../astro_CDPvs3qL.mjs';
import 'kleur/colors';
import { a as $$WidgetWrapper, b as $$Headline, e as $$Image, f as $$ItemGrid, $ as $$Button, g as $$Hero, h as $$Content, i as $$Header, d as $$PageLayout } from './about_Dn1MtR6H.mjs';
import { A as APP_BLOG, B as BLOG_BASE, C as CATEGORY_BASE, T as TAG_BASE, e as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, f as findImage, h as getPermalink, j as getBlogPermalink } from './404_h05DomhS.mjs';
import { p as prependForwardSlash } from '../astro/assets-service_-s52BX9S.mjs';
import { $ as $$Features2 } from './contact_BNCIkBvF.mjs';
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://furkaneyazici.com", "ASSETS_PREFIX": undefined}, { _: process.env._ })?.DEV && cacheEntriesByCollection.has(collection)) {
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/post/markdown-elements-demo-post.mdx": () => import('../markdown-elements-demo-post_BHYROJKW.mjs')});
...
let lookupMap = {};
lookupMap = {"post":{"type":"content","entries":{"markdown-elements-demo-post":"/src/content/post/markdown-elements-demo-post.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/post/markdown-elements-demo-post.mdx": () => import('../markdown-elements-demo-post_B-JLuQVP.mjs')});
...
}, "/home/themanyface/Projects/personal_website/mywebsite/furkaneyazici/src/components/widgets/Features3.astro", void 0);
...
}, "/home/themanyface/Projects/personal_website/mywebsite/furkaneyazici/src/components/blog/GridItem.astro", void 0);
...
}, "/home/themanyface/Projects/personal_website/mywebsite/furkaneyazici/src/components/blog/Grid.astro", void 0);
...
}, "/home/themanyface/Projects/personal_website/mywebsite/furkaneyazici/src/components/widgets/BlogLatestPosts.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const metadata = {
    title: "Furkan E\u015Fref Yaz\u0131c\u0131's personal website"
  };
...
I'm an enthusiast with a burgeoning interest in machine learning and quantum computing. While my journey into these fields is just beginning, this website represents both a starting point and a canvas for documenting my progress, learning, and future contributions. Here, I aim to share my explorations, discoveries, and the knowledge gained as I delve deeper into these fascinating areas of study, reflecting a commitment to growth and a curiosity about the potential they hold.
  ...
  ] })}  ${renderComponent($$result2, "Content", $$Content, { "id": "projects", "title": "Feautured Projects", "subtitle": "Explore my most recent projects and the creative process behind them.", "isReversed": true, "items": [], "callPageName": "More Projects", "callPagePath": "/projects" })}
,
    ${renderComponent($$result2, "BlogLatestPosts", $$BlogLatestPosts, { "id": "blog", "title": "Explore my insightful articles on my <span class='text-blue-600 dark:text-blue-400'>blog</span>", "information": "I share my thoughts, insights, and discoveries on a variety of topics, including quantum computing, machine learning, and more." }, { "bg": ($$result3) => renderTemplate`${renderComponent($$result3, "Fragment", Fragment, { "slot": "bg" }, { "default": ($$result4) => renderTemplate` <div class="absolute inset-0 bg-blue-50 dark:bg-transparent"></div> ` })}` })} ${renderComponent($$result2, "Features2", $$Features2, { "title": "I am here to help!", "id": "contact", "subtitle": "Reach out to me for collaborations, inquiries, or to simply say hello!", "items": [
    {
      title: "Email",
...
}, "/home/themanyface/Projects/personal_website/mywebsite/furkaneyazici/src/pages/index.astro", void 0);

const $$file = "/home/themanyface/Projects/personal_website/mywebsite/furkaneyazici/src/pages/index.astro";
const $$url = "";
