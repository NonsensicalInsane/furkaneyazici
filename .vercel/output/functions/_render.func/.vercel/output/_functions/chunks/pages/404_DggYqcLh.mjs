import { l as lookup, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_CobtS9Yp.mjs';
import { A as AstroError, b as InvalidImageService, c as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, d as createAstro, e as createComponent, f as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, g as addAttribute, s as spreadAttributes, h as defineScriptVars, i as renderComponent, u as unescapeHTML, j as Fragment, k as renderHead, l as renderSlot } from '../astro_Cn1-UY-y.mjs';
import 'kleur/colors';
/* empty css                           */
import fs from 'fs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_CobtS9Yp.mjs'
    ).then(n => n.h).catch((e) => {
...
const imageConfig = {"service":{"entrypoint":"astro/assets/services/squoosh","config":{}},"domains":[],"remotePatterns":[]};
					const outDir = new URL("file:///home/themanyface/Projects/personal_website/mywebsite/furkaneyazici2/.vercel/output/static/");
...
const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/icons/logo.png": () => import('./about_CtNYn95N.mjs').then(n => n.l),"/src/assets/images/icons/logo.svg": () => Promise.resolve().then(() => logo),"/src/assets/images/icons/patreon.png": () => import('../patreon_Bo0KQA5b.mjs'),"/src/assets/images/icons/patreon.svg": () => import('../patreon_dLW1SFkL.mjs'),"/src/assets/images/me.png": () => import('../me_DGdkgyfR.mjs')});
  } catch (e) {
  }
  return images;
};
